...
exports.saveCasoObsRN = exports.saveEventos = exports.saveRelevos = exports.saveMedicamentos = exports.saveMSVdat = exports.savePreEstudios = exports.saveCx = void 0;
const logger_1 = __importDefault(require("../logger"));
const Cirugias_1 = require("../models/Cirugias");
const saveCx = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { pid, numEpisodio, habitacionPacnt, fechaInPacnt, diagnostico, tipoCx, cie10, cie9, infoProced, cuerpoMed, antPersPat, antPersNoPat, sigVit, expFis, viaAerea, Estudios, perfilBioQ, pos_Cuidados, sedacion, regional, anestLocal, anestGral, obsNotaPre, balancesParciales, balanceTotal, balIng, balEgresos, datosVentilador, tiemposQX, medicamentosCx, relevoCx, evCriticoCx, datosMSV, notaPA, signVitEgQx, casoObsRecNac_NumProd, casoObsRecNac, notaEval_Obs, aldreteRec, 
