...
export default defineComponent({
  ...
  methods: {
      ...
      //             table:{
      //                 body: [
      //                   [[{text:"Hora"}],[{text:"FC"}],[{text:"Pulso"}],[{text:"PAS"}],[{text:"PAD"}],[{text:"PAM"}],[{text:"SpO2"}],[{text:"EtCO2"}],
      //                     [{text:"Temp1"}],[{text:"Temp2"}],[{text:"PVC"}],[{text:"PAS_IN"}],[{text:"PAD_IN"}],[{text:"PAM_IN"}],[{text:"FiCO2"}],[{text:"FR"}],
      //                     [{text:"Hora"}],[{text:"FC"}],[{text:"Pulso"}],[{text:"PAS"}],[{text:"PAD"}],[{text:"PAM"}],[{text:"SpO2"}],[{text:"EtCO2"}],
      //                     [{text:"Temp1"}],[{text:"Temp2"}],[{text:"PVC"}],[{text:"PAS_IN"}],[{text:"PAD_IN"}],[{text:"PAM_IN"}],[{text:"FiCO2"}],[{text:"FR"}],
      //                   ],
      //                 ]
      ...
      crearPdf() {
        ...
        const numColumnas = 5;
        const columnas = tablaDatosGrid.length > 0 ? [] : [[]];
        for (let i = 0; i < tablaDatosGrid.length; i += numColumnas) {
          columnas.push(tablaDatosGrid.slice(i, i + numColumnas));
        }
