      ...
      <div class="col-9 divform navbar-nav">                     
        <ul class="nav text-center" id=""> <!--Lista para el menú principal-->
          ...
          <li class="col-md-3">
            ...
            <form @submit.prevent="" class="dropdown-menu p-5">
              <div class="mb-3 estiloDropDownVentilador row g-3">
                <div class="col-md-9">
                  <label for="inputState"
                         class="form-label fw-bold"> Modos de ventilación </label>
                ...
                <div class="col-md-2">
                  <button type="submit"
                          ...
                          class="btn btn-outline-secondary fw-bold"> Guardar </button>
                </div>
                  ...
                  <table class="table table-hover">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td>
                          <button class="btn btn-outline-secondary fw-bold"> Editar </button>
                        </td>
                        <td>
                          <button class="btn btn-outline-secondary fw-bold"> Eliminar </button>
                        </td>
                      </tr>
                    </tbody>
                  </table>
