                ...
                <form @submit.prevent="" class="dropdown-menu p-4 color-dropdown">
                  <div class="mb-3 estiloDropDownVentilador row g-3">
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="text" class="form-control" v-model="menuTrans.frecResp"> 
                    </div>
                    <div class="col-md-3">
                        <label class="form-label fw-bold text-white">I:E</label>
                        <input type="text" class="form-control" v-model="menuTrans.IE"> 
                    </div>
                    <div class="col-md-3">
                        <label class="form-label fw-bold text-white">P. Límite</label>
                        <input type="text" class="form-control" v-model="menuTrans.PLimite"> 
                    </div>
                    <div class="col-md-9"></div>
                    <div class="col-md-2">
                      <button type="submit" class="btn btn-dropdown fw-bold" 
