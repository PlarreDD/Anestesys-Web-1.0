...
export default defineComponent({
  ...
  methods: {
    ...
    async asignarDatosPacientesCx(){
      ...
      idStore.FechaIngreso = idStore.cirugia.pacientesCx[0].fechaInPaciente == undefined ? '' : idStore.cirugia.pacientesCx[0].fechaInPaciente
    ...
    async asignarDatosPacientesTrans(){
      transStore.datosVentilacion = idStore.cirugia.pacienteTrans[0]?.datosVentilador == undefined ? '' : idStore.cirugia.pacienteTrans[0].datosVentilador
      transStore.medicamentos = idStore.cirugia.pacienteTrans[0]?.medicamentosCx == undefined ? '' : idStore.cirugia.pacienteTrans[0].medicamentosCx
      transStore.relevos = idStore.cirugia.pacienteTrans[0]?.relevoCx == undefined ? '' : idStore.cirugia.pacienteTrans[0].relevoCx
      transStore.eventos = idStore.cirugia.pacienteTrans[0]?.evCriticoCx == undefined ? '' : idStore.cirugia.pacienteTrans[0].evCriticoCx
