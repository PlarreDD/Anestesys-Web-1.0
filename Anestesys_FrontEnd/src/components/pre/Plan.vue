...
export default defineComponent({
    ...
    methods:{
        async vaciarInputsPlan(){
            ...
            this.infoPlan.regional_ProbDificulNeuro = ""
            ...
            this.infoPlan.regional_ProbDificulPlexo = ""
            this.infoPlan.regional_EspDificulPlexo = ""
            this.infoPlan.regional_Ultrasonido = ""
            this.infoPlan.regional_EspUltrasonido = ""
            this.infoPlan.regional_Neuroestimulador = ""
            this.infoPlan.regional_EspNeuroestimulador = ""
            this.infoPlan.regional_ProbComplicaciones = ""
            ...
            this.infoPlan.general_Globo = ""
            this.infoPlan.general_Presion = ""
            this.infoPlan.general_DifTecnicasIntubacion = ""
            this.infoPlan.general_EspDifTecIntubacion = ""
            this.infoPlan.general_DispositivosSupro = ""
            this.infoPlan.general_Calibre = ""
            this.infoPlan.general_Complicaciones = ""
            this.infoPlan.general_EspComplicaciones = ""
            this.infoPlan.general_OtrosDispositivos = ""
